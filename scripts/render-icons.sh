...
set -euo pipefail
cd "$(dirname "$0")/.."
BROWSER_BIN=$(ls -d ~/Library/Caches/ms-playwright/chromium_headless_shell-*/chrome-headless-shell-mac*/chrome-headless-shell 2>/dev/null | head -1) || true
